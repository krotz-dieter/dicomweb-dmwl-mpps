...
#### 0080018: SOP Instance UID, 00100010: Patient's Name, 0020000D: Study Instance UID, 00741204: Procedure Step Label, 00404025: Scheduled Station Name Code Sequence
```http
HTTP/1.1 200 OK
Content-Length: 1191
